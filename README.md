# TaylorDo
BETA RELEASE. TECHNICIANS ONLY PLS. An advanced script library using MyDefrag designed to speed up applications performance and provide an improved user experience. Not HTML.
