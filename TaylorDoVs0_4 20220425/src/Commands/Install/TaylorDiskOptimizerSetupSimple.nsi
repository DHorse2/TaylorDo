...
section "General"
  ...
  Var /GLOBAL INSTDIR
  StrCpy $INSTDIR "\Scripts\TaylorDO"
SectionEnd
...
Section "Uninstall"
  ...
  ExecWait '"$ProductAppInstallDir\Commands\TaskScheduler\DoTaskScheduleUninstall.bat"' $0
  DetailPrint "Task Scheduler removal exit code: $0"
