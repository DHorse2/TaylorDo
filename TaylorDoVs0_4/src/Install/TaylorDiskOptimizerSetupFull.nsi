...
Var /GLOBAL TaylorDoInstallDir

; convenience variable for the full path for TaylorDo.`
; Var /GLOBAL InstallDirFull

InstallDir "$PROGRAMFILES\TaylorDo"; this is set in -Settings
; registry
...
;--------------------------------
    ...
    !define MUI_DIRECTORYPAGE_VARIABLE $TaylorDoInstallDir ; Variable to store the selected folder. Default: $INSTDIR
...
taylorDoExistsContinue:
    ...
    ; CreateDirectory $TaylorDoInstallDir\backup
...
taylorDoInstall:
    ...
    WriteUninstaller $TaylorDoInstallDir\uninstaller.exe
    ...
    Pop $0
    DetailPrint "TaylorDo EnVar::Check write access HKCU returned=|$0|"
    ...
    EnVar::Check "NULL" "NULL"
    Pop $0
    DetailPrint "TaylorDo EnVar::Check write access HKLM returned=|$0|"
    ...
    ; Add a TaylorDoDir
    EnVar::AddValue "TaylorDoDir" "$TaylorDoInstallDir"
    Pop $0
    ...
    ; Write the installation path into the registry
    WriteRegStr HKLM "Software\${PRODUCT_NAME}" "Install_Dir" "$TaylorDoInstallDir"
...
Section "TalyorDo Startmenu" TaylorStartMenu
    ...
    ;--------------------------------
    ; Uninstall
    CreateShortCut "$SMPROGRAMS\$StartMenuFolder\Uninstall Example Application 1.lnk" "$TaylorDoInstallDir\Uninstall.exe"
...
unTaylorDo:
    ...
    Delete "$TaylorDoInstallDir\Uninstall.exe"

    RMDir "$TaylorDoInstallDir"
